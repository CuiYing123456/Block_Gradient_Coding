...
% Proposed Solution
prop_integer        = [0.959             0.771                0.611              0.503                0.422];
% Baseline 1 - single BCGC
Single_BCGC         = [0.936             0.746                0.592              0.476                0.409];
% Baseline 2: [Tandon, partial straggler]
Tandon              = [0.594             0.026                0.001              0.000                0.000];
% Baseline 3: [Draper]
Draper_r_L          = [0.939             0.753                0.603              0.497                0.407];

Draper_r_L_D_2      = [0.956             0.477                0.268              0.196                0.001];
