...
% N = 30; L = 4e4;
% mu = 1e-1; M = 50; b = 1; t = 10^(6.5); t_0 = 1; % 'MbN'= M*b/N
% ================================================
N = 10; L = 4e4; 
...
% ================================================v
CDF_est_basline_1_real = fun_Est_CDF_real_samples(t,I(:,i_flag)*L,num_sample,  N,M,b);
fprintf(2,['CDF_est_basline_1_real = ', num2str(CDF_est_basline_1_real), '\n']);
% ================================================^
